...
var Module = typeof WASMPlayer != 'undefined' ? WASMPlayer : {};
...
["_main","_prepare","_play","_stop","_destroy","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var ASM_CONSTS = {
  3133832: () => { console.log('open url error') },  
 3133862: () => { console.log('do not found stream info') },  
 3133902: () => { console.log('video stream not found') },  
 3133940: () => { console.log('do not found codec') },  
 3133974: () => { console.log('can not open codecContext') },  
 3134015: () => { console.error('decode error', ret) }
};
...
var _ff_h264_cabac_tables = Module['_ff_h264_cabac_tables'] = 1266892;
...
// end include: postamble.js
  ...
  return WASMPlayer.ready
}

);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = WASMPlayer;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return WASMPlayer; });
else if (typeof exports === 'object')
  exports["WASMPlayer"] = WASMPlayer;
